...
<head>
    <meta charset="utf-8" />
    <title>ProEmpresarial | TALLER METACOMPETENCIAS</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="wow fadeInUp" data-wow-delay=".6s">TALLER DE METACOMPETENCIAS</h1>
                            <div class="spacer-double"></div>
                        </div>
            ...
            <section id="section-training" data-bgimage="url(images/background/bg-2.png) bottom" class="relative">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="images/services/meta-competencias.png">
                        </div>
                        <div class="col-md-12">
                            <p>
