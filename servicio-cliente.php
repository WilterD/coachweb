                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="wow fadeInUp" data-wow-delay=".6s">SERVICIO CLIENTE</h1>
                            <div class="spacer-double"></div>
                        </div>
            ...
            <section id="section-training" data-bgimage="url(images/background/bg-2.png) bottom" class="relative">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>
                                <b>PROGRAMA DE ENTRENAMIENTO EN SERVICIO AL CLIENTE
                                    “SEPAC”</b>
                            </h2>
                        ...
                        <div class="col-md-12">
                            <h3 class="text-danger">“SERVICIO-EFICIENCIA-PRODUCTIVIDAD-AMABILIDAD-COMPROMISO”</h3>
                            <img src="images/services/sepac.png">
                        </div>
                    </div>
                    <div class="spacer-single"></div>
                    <div class="col-md-12">
                        <p>De los aspectos más importantes que actualmente ayuda a determinar las posición de la empresa tanto al mediano como a largo plazo es la información y la retroalimentación que recibimos de los clientes, acerca de nuestros productos o servicios. Para que los clientes tengan una opinión positiva debemos tenerlos claramente satisfechos, además de cubrirles todas sus necesidades y expectativas.</p>
                        <p>
                            Los asistentes al entrenamiento “SEPAC” evaluaran sus características personales que le permiten tener éxito en su labor diaria, recibirán información conceptual de los aspectos principales para que el proceso de servicio sea el esperado por el cliente en este entrenamiento desarrollara las habilidades de servicio que son necesarias cuando se está de cara a los clientes</p>
                        <p>
                        ...
                        <b>OBJETIVOS DEL ENTRENAMIENTO “SEPAC”</b>
                        <p>
                        ...
                        <b>METODOLOGÍA</b>
                        <p>
                            Para que el entrenamiento sea efectivo debe desarrollarse un proceso de diagnóstico para evaluar las habilidades actuales, pero también debe haber un entrenamiento que permita desarrollar esas destrezas, junto con esto la retroalimentación efectiva con el fin de generar habilidades, este proceso lo realizamos en tres pasos:</p>
                        <p>

                            ​PASO 1: DIAGNOSTICO ACTUAL DEL SERVICIO</p>
                        <p>
                            Usamos nuestra prueba estrella que es el DISC ADEP/DIAV para medir el nivel de comportamiento de las areas de Servicio al cliente
                            ​Mediante unas preguntas se evalúa la gestión actual de servicio con respecto a los clientes y la importancia de las empresas del servicio.</p>
                        <p>

                            PASO 2: ENTRENAMIENTO</p>
                        <p>

                            Se realizan talleres, simulaciones, situaciones, apoyados en el diagnóstico que permitan trabajar completamente las habilidades que no se han desarrollado efectivamente por parte de los participantes, ejercicios prácticos de servicio, dependiendo de los participantes se pueden hacer efectivas ejercicios de servicio, llamadas telefónicas, recepción de documentos, evaluaciones de desempeño entre otras.</p>
                        <p>
                    ...
                    <div class="container">
                        <div class="row">
                    <div class="col-md-6">
                        <img class="img-fluid" src="images/services/img1-service-cliente.jpg">
                    </div>
                    <div class="col-md-6">
                        <img class="img-fluid" src="images/services/img2-servicio-cliente.jpg">
                    </div>
                    </div>
                    </div>
                </div>
