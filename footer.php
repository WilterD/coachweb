<!-- section begin -->
<section id="section-contact" data-bgimage="url(images/background/bg-2b.png) bottom #e4e6e9">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form name="contactForm" id='contact_form' class="form-default" method="post" action='email.php'>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div id='email_error' class='error'>Por favor ingresa tu correo electrónico</div>
                                        <div>
                                            <input type='text' name='email' id='email' class="form-control" placeholder="Correo Electrónico">
                                        </div>

                                        <div id='phone_error' class='error'>Por favor ingresa tu número de telefóno</div>
                                        <div>
                                            <input type='text' name='phone' id='phone' class="form-control" placeholder="Teléfono">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div id='message_error' class='error'>Por favor ingresa un mensaje</div>
                                        <div>
                                            <textarea name='message' id='message' class="form-control" placeholder="Mensaje Adicional"></textarea>
                                        </div>
                                    </div>
